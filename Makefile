...
Makefile: tpmcoin-qt.pro ../mxe/usr/i686-w64-mingw32.static/qt5/mkspecs/win32-g++/qmake.conf ../mxe/usr/i686-w64-mingw32.static/qt5/mkspecs/features/spec_pre.prf \
...
clean: release-clean debug-clean  FORCE
	-$(DEL_FILE) /mnt/tpmcoin/src/leveldb/libleveldb.a;
	-$(DEL_FILE) cd
	-$(DEL_FILE) /mnt/tpmcoin/src/leveldb
	-$(DEL_FILE) ;
	-$(DEL_FILE) clean
distclean: release-distclean debug-distclean  FORCE
	-$(DEL_FILE) Makefile
	-$(DEL_FILE) /mnt/tpmcoin/tpmcoin_plugin_import.cpp

/mnt/tpmcoin/src/leveldb/libleveldb.a: FORCE
