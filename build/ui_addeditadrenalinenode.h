...
public:
    ...
    {
        AddEditAdrenalineNode->setWindowTitle(QApplication::translate("AddEditAdrenalineNode", "Add/Edit TpmCoin Masternode", 0));
        label_9->setText(QApplication::translate("AddEditAdrenalineNode", "<html><head/><body><p>Enter an Alias (friendly name) for your <span style=\" font-weight:600;\">TpmCoin Masternode</span> and its address (either a clearnet IP and port or Tor onion address and port).</p><p>The address should be in the format <span style=\" font-style:italic;\">155.456.789.123:19999</span> or <span style=\" font-style:italic;\">akjdsafxjkhasdf.onion:19999</span>. </p><p>You must send exactly <span style=\" font-weight:600; text-decoration: underline;\">5000 TPM</span> to the collateral address.</p></body></html>", 0));
