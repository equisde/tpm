...
public:
    ...
    void retranslateUi(QDialog *AdrenalineNodeConfigDialog)
    {
        ...
        detailText->setToolTip(QApplication::translate("AdrenalineNodeConfigDialog", "<html><head/><body><p>This pane shows an example tpmcoin.conf template with the necessary masternode settings.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
