...
public:
    ...
    void setupUi(QDialog *Intro)
    {
        ...
        label->setPixmap(QPixmap(QString::fromUtf8(":/icons/tpmcoin128")));
    ...
    void retranslateUi(QDialog *Intro)
    {
        ...
        label_2->setText(QApplication::translate("Intro", "Welcome to TpmCoin!", 0));
        label_4->setText(QApplication::translate("Intro", "This is the first time <strong>TpmCoin</strong> has launched on this computer, so you can choose where TpmCoin will store its data.", 0));
        sizeWarningLabel->setText(QApplication::translate("Intro", "TpmCoin will download and store a copy of the TpmCoin block chain. At least <strong>%1GB</strong> of data will need to be available to be stored in this directory, as it will grow over time. The wallet data will also be stored in this directory.", 0));
