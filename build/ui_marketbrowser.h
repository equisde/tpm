...
public:
    ...
    void setupUi(QWidget *MarketBrowser)
    {
        ...
        tpmcoin = new QLabel(MarketBrowser);
        tpmcoin->setObjectName(QStringLiteral("tpmcoin"));
        sizePolicy1.setHeightForWidth(tpmcoin->sizePolicy().hasHeightForWidth());
        tpmcoin->setSizePolicy(sizePolicy1);
        QFont font;
        font.setPointSize(27);
        tpmcoin->setFont(font);
        tpmcoin->setMouseTracking(true);
        tpmcoin->setText(QStringLiteral("$ 1000 USD"));
        tpmcoin->setScaledContents(false);
        tpmcoin->setAlignment(Qt::AlignCenter);

        horizontalLayout_5->addWidget(tpmcoin);
        ...
        label_3->setPixmap(QPixmap(QString::fromUtf8(":/icons/tpmcoin")));
    ...
    void retranslateUi(QWidget *MarketBrowser)
    {
        ...
        label_4->setText(QApplication::translate("MarketBrowser", "<html><head/><body><p><span style=\" font-size:20px;font-weight:600; color:#FFFFFF;\">TpmCoin Market Information</span></p></body></html>", 0));
        dnrbtc->setText(QApplication::translate("MarketBrowser", "0.1 BTC", 0));
        startButton->setText(QApplication::translate("MarketBrowser", "Refresh Prices", 0));
        label_15->setText(QApplication::translate("MarketBrowser", "<html><head/><body><p><span style=\" font-weight:600; color:#767676;\">Current TPM Market Cap</span></p></body></html>", 0));
        label_5->setText(QApplication::translate("MarketBrowser", "<html><head/><body><p><span style=\" font-weight:600; color:#767676;\">Last TPM/BTC Price</span></p></body></html>", 0));
        label_14->setText(QApplication::translate("MarketBrowser", "<html><head/><body><p><span style=\" font-weight:600; color:#767676;\">Last TPM/USD Price</span></p></body></html>", 0));
        ...
        label_31->setText(QApplication::translate("MarketBrowser", "<html><head/><body><p><span style=\" font-weight:600; color:#767676;\">TPM Price Calculator :</span></p></body></html>", 0));
        label->setText(QApplication::translate("MarketBrowser", "TPM", 0));
