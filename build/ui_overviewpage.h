...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        labelStake->setText(QStringLiteral("0 TPM"));
        ...
        labelTotal->setText(QStringLiteral("35626236326.63632636 TPM"));
        ...
        labelWatchTotal->setText(QStringLiteral("0 TPM"));
        ...
        labelWatchImmature->setText(QStringLiteral("0 TPM"));
        ...
        labelWatchAvailable->setText(QStringLiteral("0 TPM"));
        ...
        labelBalance->setText(QStringLiteral("0 TPM"));
        ...
        labelCLPTotal = new QLabel(frame);
        labelCLPTotal->setObjectName(QStringLiteral("labelCLPTotal"));
        labelCLPTotal->setFont(font3);
        labelCLPTotal->setCursor(QCursor(Qt::IBeamCursor));
        labelCLPTotal->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);

        gridLayout->addWidget(labelCLPTotal, 12, 1, 1, 2);
        ...
        labelImmature->setText(QStringLiteral("0 TPM"));
        ...
        labelUnconfirmed->setText(QStringLiteral("0 TPM"));
        ...
        clptotal = new QLabel(frame);
        clptotal->setObjectName(QStringLiteral("clptotal"));

        gridLayout->addWidget(clptotal, 12, 0, 1, 1);
        ...
        gridLayout->addWidget(refreshButton, 13, 1, 1, 2);
        ...
        labelWatchPending->setText(QStringLiteral("0 TPM"));
        ...
        logo->setPixmap(QPixmap(QString::fromUtf8(":/icons/tpmcoin")));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the TpmCoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
        labelTradeLink->setText(QApplication::translate("OverviewPage", "<div style=\"color: #fff;\">(<a href=\"https://trade.thexchanger.io/market/BTC-TPM\" style=\"color: #fff;\">Trade TPM</a>)</div>", 0));
...
#endif // QT_NO_TOOLTIP
        labelUSDTotal->setText(QApplication::translate("OverviewPage", "0 USD", 0));
#ifndef QT_NO_TOOLTIP
        labelCLPTotal->setToolTip(QApplication::translate("OverviewPage", "Your current total balance estimated in USD, Rate is not updated often", 0));
#endif // QT_NO_TOOLTIP
        labelCLPTotal->setText(QApplication::translate("OverviewPage", "0 USD", 0));
        ...
        clptotal->setText(QApplication::translate("OverviewPage", "CLP Total:", 0));
...
#endif // QT_NO_TOOLTIP
        labelLocked->setText(QApplication::translate("OverviewPage", "0 TPM", 0));
        label_4->setText(QApplication::translate("OverviewPage", "<b>Recent Transactions</b>", 0));
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the TpmCoin network after a connection is established, but this process has not completed yet.", 0));
#endif // QT_NO_TOOLTIP
