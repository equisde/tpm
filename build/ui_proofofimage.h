...
public:
    ...
    void retranslateUi(QWidget *ProofOfImage)
    {
        ...
        label_6->setText(QApplication::translate("ProofOfImage", "Enter up to a 24 character narration to store in the chain:", 0));
        createPushButton->setText(QApplication::translate("ProofOfImage", "Create Timestamp (Pay 0.001 TPM) Proof of Data*", 0));
        label_2->setText(QApplication::translate("ProofOfImage", "<html><head/><body><p><span style=\" font-style:italic; color:#ff0000;\">*Warning:</span> This sends <span style=\" font-weight:600;\">0.001 TPM</span> to a new address generated by hashing the image or data file selected. The address can be checked on a TpmCoin block explorer for a proof of creation date timestamp.</p></body></html>", 0));
        label->setText(QApplication::translate("ProofOfImage", "Generated Timestamp TpmCoin Address:", 0));
        ...
        label_5->setText(QApplication::translate("ProofOfImage", "Check a previous Transaction Hash for TpmCoin proofs.", 0));
