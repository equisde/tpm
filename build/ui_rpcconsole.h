...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "TpmCoin - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "TpmCoin Core", 0));
        ...
        label_81->setText(QApplication::translate("RPCConsole", "Native Tor On/Off", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the TpmCoin debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the TpmCoin-Qt help message to get a list with possible TpmCoin command-line options.", 0));
#endif // QT_NO_TOOLTIP
