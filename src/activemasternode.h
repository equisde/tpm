...
// Responsible for activating the masternode and tpmcoining the network
...
public:
    ...
    bool Dseep(std::string& errorMessage); // tpmcoin for main masternode
    bool Dseep(CTxIn vin, CService service, CKey key, CPubKey pubKey, std::string &retErrorMessage, bool stop); // tpmcoin for any masternode
    ...
    // get 5000TPM input that can be used for the masternode
