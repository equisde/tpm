...
#ifndef BITCOIN_ALLOCATPMS_H
#define BITCOIN_ALLOCATPMS_H
 ...
 * those functions are used naively. This class simulates stacking memory locks by keetpmcoin a counter per page.
 *
