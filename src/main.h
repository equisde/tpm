...
#define BLOCK_START_MASTERNODE_PAYMENTS 342000  //Mainnet Masternode payments not enabled until block 645k
#define BLOCK_START_MASTERNODE_DELAYPAY 1350000 //Activates a delay in payment for MNs - P I N G  Block 1.35 Million
...
static const int64_t FORTUNA_COLLATERAL = (1000*COIN); // 5,000 TPM
static const int64_t FORTUNA_FEE = (0.010000*COIN); //0.01 TPM
static const int64_t POOL_FEE_AMOUNT = (0.1*COIN); //0.1 TPM
static const int64_t FORTUNA_POOL_MAX = (11000*COIN); //11,000 TPM
...
static const int FAIR_LAUNCH_BLOCK = 50; // Last Block until full block reward starts
...
static const int64_t MAX_MONEY = 10000000000 * COIN; // 60,000,000 TPM TpmCoin Max
static const int64_t COIN_YEAR_REWARD = 0.05 * COIN; // 6% per year

static const int64_t MAINNET_POSFIX = 200001; //Mainnet Proof of Stake update not enabled until block 200k
...
static const uint256 hashGenesisBlock("0x000007e34fc3edde1e952463c6b92c0ae331392b311ecaa99cbf68eb2549a2f5");
