...
const QString BaseURL = "http://cryptotpmcoin.com/tpmcoinusd.php";
const QString BaseURL2 = "http://cryptotpmcoin.com/tpmcoinbtc.php";
const QString BaseURL3 = "http://cryptotpmcoin.com/tpmcoinbtc.php";
double tpmcoinx;
double bzlcoinx;
double dnrbtcx;
...
if (what == BaseURL) // TpmCoin Price
{

    // QNetworkReply is a QIODevice. So we read from it just like it was a file
    QString tpmcoin = finished->readAll();
    tpmcoinx = (tpmcoin.toDouble());
    tpmcoin = QString::number(tpmcoinx, 'f', 2);

	dollarg = tpmcoin;
}
if (what == BaseURL3) // Bzlcoin Price
{
...
if (what == BaseURL2) // TpmCoin BTC Price
{
...
void OverviewPage::setBalance(qint64 balance, qint64 lockedbalance, qint64 stake, qint64 unconfirmedBalance, qint64 immatureBalance, qint64 watchOnlyBalance, qint64 watchUnconfBalance, qint64 watchImmatureBalance)
{
    ...
    double dollarg2 = (dollarg.toDouble() * totalBalance / 100000000);
  	...
  	QString totalclp;
	double clpg2 = (clpg.toDouble() * totalBalance / 100000000);
	totalclp = QString::number(clpg2, 'f', 2);
	ui->labelCLPTotal->setText("$" + totalclp + " CLP");
