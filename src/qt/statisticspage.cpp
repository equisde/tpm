...
void StatisticsPage::updateStatistics()
{
    ...
    {
        subsidy = "0.2 TPM per block";
    }
    else if (pindexBest->nHeight <= 3398)
    {
        subsidy = "0.5 TPM per block";
    }
    ...
    {
        subsidy = "0.1 TPM per block";
    }
    else if (pindexBest->nHeight > 2000000)
    {
        subsidy = "0.01 TPM per block";
    }
    else if (pindexBest->nHeight <= 3000000)
    {
        subsidy = "0";
    ...
    {
        ui->volumeBox->setText("<b><font color=\"yellow\">" + qVolume + " TPM" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " TPM" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"orange\">" + qVolume + " TPM" + "</font></b>");
    }
