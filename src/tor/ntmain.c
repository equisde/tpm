 ...
 * have entry points for starting, stoptpmcoin, and monitoring them.  This module
 ...
 */
int
nt_service_is_stoptpmcoin(void)
{
...
/** Handles service control requests, such as stoptpmcoin or starting the
 * Tor service. */
static void
...
{
  /* Notes about develotpmcoin NT services:
   *
